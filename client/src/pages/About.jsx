...
function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About HouseHue</h1>
      <p className="mb-4 text-slate-700">
        HouseHue is a leading real estate agency that specializes in helping
      ...
      <p className="mb-4 text-slate-700">
        ...
        estate industry, and we are commited to providing the highest level of
